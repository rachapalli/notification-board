...
public class CommonsConfigurationFactoryBean implements InitializingBean, FactoryBean {
	...
	public CommonsConfigurationFactoryBean() {
		// Constructor for creating the CommonsConfigurationFactoryBean
	}

	public CommonsConfigurationFactoryBean(Configuration configuration) {
		// Assert.notNull(configuration); deprecated warning
	 ...
	 */
	public Class<java.util.Properties> getObjectType() {
	...
	/**
	 * Shortcut for loading configuration from Spring resources. It will internally
	 * create a PropertiesConfiguration object based on the URL retrieved from the
	 * given Resources.
	 * 
	 * @param locations
	 */
